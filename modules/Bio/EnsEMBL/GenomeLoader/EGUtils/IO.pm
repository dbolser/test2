...
our @EXPORT_OK = qw(println slurp quote parse_json write_out process_dir);
...
=head1 SYNOPSIS
	...
	use EGUtils::IO qw(println);

	println('Hello'); # sends Hello\n to STDOUT

=head1 DESCRIPTION

A collection of subroutines aimed to helping IO operations
