...
sub new {
	...
	$self->{plugin_names} = {
		...
		BIOTYPES()->{NON_TRANSLATING_TYPE} =>
		  "GenomeLoader::GeneLoader::PseudoGeneLoader",
		BIOTYPES()->{NCRNA_TYPE} => "GenomeLoader::GeneLoader::RnaGeneLoader",
		...
		BIOTYPES()->{RNASEMRP_TYPE} =>
		  "GenomeLoader::GeneLoader::RnaGeneLoader",
		BIOTYPES()->{TMRNA_TYPE}   => "GenomeLoader::GeneLoader::RnaGeneLoader",
		BIOTYPES()->{SRP_RNA_TYPE} => "GenomeLoader::GeneLoader::RnaGeneLoader",
		BIOTYPES()->{SN_RNA_TYPE}  => "GenomeLoader::GeneLoader::RnaGeneLoader",
		BIOTYPES()->{S_RNA_TYPE}  => "GenomeLoader::GeneLoader::RnaGeneLoader",
		BIOTYPES()->{SNO_RNA_TYPE} => "GenomeLoader::GeneLoader::RnaGeneLoader",
		BIOTYPES()->{RRNA_TYPE}  => "GenomeLoader::GeneLoader::RRNAGeneLoader",
		BIOTYPES()->{MIRNA_TYPE} => "GenomeLoader::GeneLoader::RnaGeneLoader",
		BIOTYPES()->{ANTITOXIN_TYPE} => "GenomeLoader::GeneLoader::RnaGeneLoader",
		BIOTYPES()->{CRISPR_TYPE} => "GenomeLoader::GeneLoader::RnaGeneLoader",
		BIOTYPES()->{TRNA_TYPE}  => "GenomeLoader::GeneLoader::TRNAGeneLoader",
		BIOTYPES()->{RIBOZYME_TYPE}  => "GenomeLoader::GeneLoader::TRNAGeneLoader",
