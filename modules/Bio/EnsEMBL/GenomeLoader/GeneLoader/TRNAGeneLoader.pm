...
#
package Bio::EnsEMBL::GenomeLoader::GeneLoader::TRNAGeneLoader;
use warnings;
use strict;
...
GenomeLoader::FeatureLoader::TRNAGeneLoader

=head1 SYNOPSIS

Create a new gene for a tRNA gene
...
=head2 get_rna_display_xref
  ...
  Description: get xref for TRNASCAN to use as display xref
