...
public class GenomeInfoImpl implements Serializable, GenomeInfo {
     ...
     * (non-Javadoc)
     * 
     * @see org.ensembl.genomeloader.genomebuilder.model.impl.Genome#getId()
     */
    public String getId() {
        return id;
    }
     ...
     * (non-Javadoc)
     * 
     * @see org.ensembl.genomeloader.genomebuilder.model.impl.Genome#getOrganism()
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.ensembl.genomeloader.genomebuilder.model.impl.Genome#getTaxId()
     */
    public int getTaxId() {
        return taxId;
    }
